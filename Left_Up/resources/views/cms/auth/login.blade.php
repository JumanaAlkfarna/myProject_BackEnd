...
<head>
  ...
  <title>  ليفت أب |  تسجيل الدخول</title>
...
<div class="login-box">
  <div class=" text-center mb-3 fs-5">
   <h3>
    <a href="{{ route('viewUser.login') }}" class="text-dark"><b>موقع  ليفت أب</b></a>
   </h3>
   <a  href="{{ route('viewUser.login') }}" class="btn btn-dark " >العودة للموقع</a>
  </div>
  <!-- /.login-logo -->
