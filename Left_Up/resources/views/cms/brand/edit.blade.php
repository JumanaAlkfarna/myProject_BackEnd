...
@section('active title' , 'تعديل ماركة')
            ...
            <div class="card-body">
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        value="{{ $brands->nameAr }}"  placeholder="أدخل الاسم بالعربي">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="nameEn">الاسم باللغة الانجليزية</label>
                        <input type="text" class="form-control" id="nameEn" name="nameEn"
                        value="{{ $brands->nameEn }}"  placeholder="أدخل الاسم بالانجليزي">
                    </div>
                </div>
                ...
                <div class="card-footer">
                    <button type="button" onclick="performUpdate({{ $brands->id }})" class="btn btn-primary">تعديل</button>
...
<script>
    ...
    storeRoute('/cms/admin/update-brands/'+id , formData)
  }
