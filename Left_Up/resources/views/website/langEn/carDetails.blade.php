...
@section('content')
    ...
    <form method="POST" action="{{ route('book_store') }}" enctype="multipart/form-data">
        @csrf
        <div class="en">
            <h2 class="text-center mb-2 add display-6 mt-2">Add a car</h2>
        </div>
        <ul class="nav nav-pills mt-3 " id="pills-tab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="pp active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home"
                    type="button" role="tab" aria-controls="pills-home" aria-selected="true"> car type
                </button>
            </li>
        ...
        <div class="  tab-content  " id="pills-tabContent">
            <div class=" py-3 px-5 tab-pane fade description show active" id="pills-home" role="tabpanel"
                            ...
                            <div class="row row-cols-1    row-cols-md-2 mx-auto ps-lg-5 ms-md-2">
                                <div class="col mb-md-5 mb-2  ">
                                    <div>
                                        ...
                                        <select id="pet-select" placeholder="Brand" id="brand_id" name="brand_id">
                                            @foreach ($cars as $car)
                                                <option class="brand" value="{{ $car->id }}">{{ $car->brand->nameEn }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col  mb-md-5 mb-2 ">
                                    <div>
                                        ...
                                        <select id="pet-select" placeholder="Brand" id="model_id" name="model_id">
                                            @foreach ($cars as $car)
                                                <option class="brand" value="{{ $car->id }}">
                                                    {{ $car->modeel->nameEn }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col  mb-md-5 mb-2 ">
                                    <div>
                                        ...
                                        <select id="pet-select" placeholder="Brand" id="year_id" name="year_id">
                                            @foreach ($cars as $car)
                                                <option class="brand" value="{{ $car->id }}">{{ $car->year->year }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col  mb-md-5 mb-2 ">
                                    <div>
                                        ...
                                        <select id="pet-select" placeholder="Brand" id="cylinder_id" name="cylinder_id">
                                            @foreach ($cars as $car)
                                                <option class="brand" value="{{ $car->id }}">{{ $car->cylinder->num }}
                                                </option>
                                            @endforeach
                                        </select>
            ...
            <div class="tab-pane fade" id="pills-ll" role="tabpanel" aria-labelledby="pills-profile-tab"
                tabindex="0">
                <section class="time">
                    <div class="container-fluid text-center mx-auto">
                        ...
                        <div class=" cars    mx-auto">
                            ...
                            @foreach ($times as $time)
                                <input hidden type="text" value="{{ $time->id}}" class="form-control time_id "
                                    name="time_id" id="time_id" placeholder="">
